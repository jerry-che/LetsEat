...
class RatingsView: UIControl {
    ...
    //Used if a UIView instance is added using code
    override init(frame: CGRect){
        super.init(frame: frame)
    }
    
    //Used it a UIView instance is in a storyboard file
    ...
    override func draw(_ rect: CGRect){
        ...
        //Context is like a scratch pad to draw something
        let context = UIGraphicsGetCurrentContext()
        context!.setFillColor(#colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0))
        context!.fill(rect)
        
        //Gets the dimension of the stars to be drawn
